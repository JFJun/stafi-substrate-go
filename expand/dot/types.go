...
func (d *DotEventRecords) GetSystemExtrinsicSuccess() []types.EventSystemExtrinsicSuccess {
	return d.System_ExtrinsicSuccess
}
func (d *DotEventRecords) GetSystemExtrinsicFailed() []types.EventSystemExtrinsicFailed {
